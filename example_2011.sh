...
then
    ...
    cp example_2011_data/generator-py.config.json generator-py/config.json
    cp example_2011_data/shaper-py.config.json shaper-py/config.json
    cp example_2011_data/analyzer-py.config.json analyzer-py/config.json
fi
